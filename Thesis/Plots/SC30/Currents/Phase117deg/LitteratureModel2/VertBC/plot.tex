...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6454,897){\makebox(0,0){\tiny \(2e{-10}\)}}%
      \put(6454,1217){\makebox(0,0){\tiny \(4e{-10}\)}}%
      \put(6454,1537){\makebox(0,0){\tiny \(6e{-10}\)}}%
      \put(6454,1857){\makebox(0,0){\tiny \(8e{-10}\)}}%
      \put(6454,2177){\makebox(0,0){\tiny \(1e{-09}\)}}%
      \put(6454,2497){\makebox(0,0){\tiny \(1e{-09}\)}}%
      \put(6454,2817){\makebox(0,0){\tiny \(1e{-09}\)}}%
      \put(6454,3137){\makebox(0,0){\tiny \(2e{-09}\)}}%
      \put(6454,3457){\makebox(0,0){\tiny \(2e{-09}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Currents/Phase117deg/LitteratureModel2/VertBC/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
