...
\begin{picture}(5760.00,3772.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(4056,3313){\makebox(0,0){\strut{}AM}}%
    ...
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Correlation_cdagg_c_/HeatMap/Phase117deg/LitteratureModel1/VertBC/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
