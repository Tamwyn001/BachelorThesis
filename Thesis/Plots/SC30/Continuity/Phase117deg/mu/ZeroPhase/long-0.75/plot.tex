...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5981,820){\makebox(0,0){\tiny \(9.0e{-03}\)}}%
      \put(5981,1212){\makebox(0,0){\tiny \(9.5e{-03}\)}}%
      \put(5981,1604){\makebox(0,0){\tiny \(1.0e{-02}\)}}%
      \put(5981,1996){\makebox(0,0){\tiny \(1.1e{-02}\)}}%
      \put(5981,2388){\makebox(0,0){\tiny \(1.1e{-02}\)}}%
      \put(5981,2780){\makebox(0,0){\tiny \(1.2e{-02}\)}}%
      \put(5981,3172){\makebox(0,0){\tiny \(1.2e{-02}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Continuity/Phase117deg/mu/ZeroPhase/long-0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
