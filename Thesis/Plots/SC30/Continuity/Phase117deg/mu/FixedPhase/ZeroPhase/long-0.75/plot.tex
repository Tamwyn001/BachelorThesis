...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5981,1055){\makebox(0,0){\tiny \(-4.00e{-02}\)}}%
      \put(5981,1525){\makebox(0,0){\tiny \(-2.00e{-02}\)}}%
      \put(5981,1996){\makebox(0,0){\tiny \(0\)}}%
      \put(5981,2466){\makebox(0,0){\tiny \(2.00e{-02}\)}}%
      \put(5981,2936){\makebox(0,0){\tiny \(4.00e{-02}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Continuity/Phase117deg/mu/FixedPhase/ZeroPhase/long-0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
