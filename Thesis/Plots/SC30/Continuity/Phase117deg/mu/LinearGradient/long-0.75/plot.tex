...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5981,1760){\makebox(0,0){\tiny \(1.0\)}}%
      \put(5981,2231){\makebox(0,0){\tiny \(1.1e{+00}\)}}%
      \put(5981,2701){\makebox(0,0){\tiny \(1.1e{+00}\)}}%
      \put(5981,3172){\makebox(0,0){\tiny \(1.1e{+00}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Continuity/Phase117deg/mu/LinearGradient/long-0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
