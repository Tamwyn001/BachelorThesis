...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6454,989){\makebox(0,0){\tiny \(2e{-05}\)}}%
      \put(6454,1400){\makebox(0,0){\tiny \(4e{-05}\)}}%
      \put(6454,1811){\makebox(0,0){\tiny \(6e{-05}\)}}%
      \put(6454,2223){\makebox(0,0){\tiny \(8e{-05}\)}}%
      \put(6454,2634){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6454,3045){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6454,3457){\makebox(0,0){\tiny \(1e{-04}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Current/Phase117deg/mu/ZeroPhase/long0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
