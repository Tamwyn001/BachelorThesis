...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6454,1057){\makebox(0,0){\tiny \(1e{-05}\)}}%
      \put(6454,1537){\makebox(0,0){\tiny \(2e{-05}\)}}%
      \put(6454,2017){\makebox(0,0){\tiny \(3e{-05}\)}}%
      \put(6454,2497){\makebox(0,0){\tiny \(4e{-05}\)}}%
      \put(6454,2977){\makebox(0,0){\tiny \(5e{-05}\)}}%
      \put(6454,3456){\makebox(0,0){\tiny \(6e{-05}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Current/Phase117deg/mu/FixedPhase/LinearGradient/long0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
