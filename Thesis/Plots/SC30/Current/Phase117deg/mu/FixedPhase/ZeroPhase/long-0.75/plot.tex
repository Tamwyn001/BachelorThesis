...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6454,897){\makebox(0,0){\tiny \(2e{-05}\)}}%
      \put(6454,1217){\makebox(0,0){\tiny \(4e{-05}\)}}%
      \put(6454,1537){\makebox(0,0){\tiny \(6e{-05}\)}}%
      \put(6454,1857){\makebox(0,0){\tiny \(8e{-05}\)}}%
      \put(6454,2177){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6454,2497){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6454,2817){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6454,3137){\makebox(0,0){\tiny \(2e{-04}\)}}%
      \put(6454,3457){\makebox(0,0){\tiny \(2e{-04}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Current/Phase117deg/mu/FixedPhase/ZeroPhase/long-0.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
