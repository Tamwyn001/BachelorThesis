...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6080,377){\makebox(0,0){\tiny \(2e{-04}\)}}%
      \put(6080,754){\makebox(0,0){\tiny \(3e{-04}\)}}%
      \put(6080,1131){\makebox(0,0){\tiny \(4e{-04}\)}}%
      \put(6080,1508){\makebox(0,0){\tiny \(5e{-04}\)}}%
      \put(6080,1885){\makebox(0,0){\tiny \(6e{-04}\)}}%
      \put(6080,2262){\makebox(0,0){\tiny \(7e{-04}\)}}%
      \put(6080,2639){\makebox(0,0){\tiny \(8e{-04}\)}}%
      \put(6080,3016){\makebox(0,0){\tiny \(9e{-04}\)}}%
      \put(6080,3393){\makebox(0,0){\tiny \(1e{-03}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/Current/mu/2.75/LinearPhaseGradient/1.0472/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
