...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      \csname LTb\endcsname%%
      \put(5288,1325){\makebox(0,0)[l]{\strut{}\footnotesize $\mu =2.75$}}%
      \csname LTb\endcsname%%
    ...
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30/MeanLine_Phase/FixedLinearPhaseGradient/PhaseSide-1.0472/MU-2.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
