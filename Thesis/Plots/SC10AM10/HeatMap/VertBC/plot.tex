...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5743,1212){\makebox(0,0){\tiny \(2e{-06}\)}}%
      \put(5743,1604){\makebox(0,0){\tiny \(4e{-06}\)}}%
      \put(5743,1996){\makebox(0,0){\tiny \(6e{-06}\)}}%
      \put(5743,2388){\makebox(0,0){\tiny \(8e{-06}\)}}%
      \put(5743,2780){\makebox(0,0){\tiny \(1e{-05}\)}}%
      \put(5743,3172){\makebox(0,0){\tiny \(1e{-05}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC10AM10/HeatMap/VertBC/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
