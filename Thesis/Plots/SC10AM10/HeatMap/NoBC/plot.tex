...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(5743,1081){\makebox(0,0){\tiny \(2e{-06}\)}}%
      \put(5743,1342){\makebox(0,0){\tiny \(4e{-06}\)}}%
      \put(5743,1604){\makebox(0,0){\tiny \(6e{-06}\)}}%
      \put(5743,1865){\makebox(0,0){\tiny \(8e{-06}\)}}%
      \put(5743,2126){\makebox(0,0){\tiny \(1e{-05}\)}}%
      \put(5743,2388){\makebox(0,0){\tiny \(1e{-05}\)}}%
      \put(5743,2649){\makebox(0,0){\tiny \(1e{-05}\)}}%
      \put(5743,2910){\makebox(0,0){\tiny \(2e{-05}\)}}%
      \put(5743,3172){\makebox(0,0){\tiny \(2e{-05}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC10AM10/HeatMap/NoBC/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
