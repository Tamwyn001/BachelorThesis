...
\begin{picture}(5760.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6080,712){\makebox(0,0){\tiny \(5e{-07}\)}}%
      \put(6080,1047){\makebox(0,0){\tiny \(1e{-06}\)}}%
      \put(6080,1382){\makebox(0,0){\tiny \(2e{-06}\)}}%
      \put(6080,1717){\makebox(0,0){\tiny \(2e{-06}\)}}%
      \put(6080,2052){\makebox(0,0){\tiny \(2e{-06}\)}}%
      \put(6080,2387){\makebox(0,0){\tiny \(3e{-06}\)}}%
      \put(6080,2722){\makebox(0,0){\tiny \(4e{-06}\)}}%
      \put(6080,3057){\makebox(0,0){\tiny \(4e{-06}\)}}%
      \put(6080,3393){\makebox(0,0){\tiny \(5e{-06}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{Plots/SC30DiffMU/Current/mu-3.75/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
