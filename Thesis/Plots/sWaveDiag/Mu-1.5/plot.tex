...
\begin{picture}(7920.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(7500,1878){\makebox(0,0){\tiny $ 10^{ -3}$}}%
      \put(7500,2287){\makebox(0,0){\tiny $ 10^{ -2}$}}%
      \put(7500,2696){\makebox(0,0){\tiny $ 10^{ -1}$}}%
      \put(7171,3164){\makebox(0,0){\strut{}$\langle c_{i\uparrow}c_{i\downarrow}\rangle$}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={396.00bp},height={188.60bp}]{../Plots/sWaveDiag/Mu-1.5/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
