...
\begin{picture}(5760.00,3772.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(1440,3630){\makebox(0,0){\strut{}SC}}%
      \put(4319,3630){\makebox(0,0){\strut{}AM}}%
    }%
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6080,377){\makebox(0,0){\tiny \(0\)}}%
      \put(6080,879){\makebox(0,0){\tiny \(5e{-05}\)}}%
      \put(6080,1382){\makebox(0,0){\tiny \(1e{-04}\)}}%
      \put(6080,1885){\makebox(0,0){\tiny \(2e{-04}\)}}%
      \put(6080,2387){\makebox(0,0){\tiny \(2e{-04}\)}}%
      \put(6080,2890){\makebox(0,0){\tiny \(2e{-04}\)}}%
      \put(6080,3393){\makebox(0,0){\tiny \(3e{-04}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={288.00bp},height={188.60bp}]{../Plots/SC15AM15/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
