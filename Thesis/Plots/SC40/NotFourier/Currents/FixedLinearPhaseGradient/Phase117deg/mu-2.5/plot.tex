...
\begin{picture}(7920.00,3772.00)%
    ...
    \gplgaddtomacro\gplfronttext{%
      ...
      \put(6960,484){\makebox(0,0){\tiny \(1.5e{-03}\)}}%
      \put(6960,1087){\makebox(0,0){\tiny \(2.0e{-03}\)}}%
      \put(6960,1690){\makebox(0,0){\tiny \(2.5e{-03}\)}}%
      \put(6960,2293){\makebox(0,0){\tiny \(3.0e{-03}\)}}%
      \put(6960,2896){\makebox(0,0){\tiny \(3.5e{-03}\)}}%
      \put(6960,3500){\makebox(0,0){\tiny \(4.0e{-03}\)}}%
    }%
    \gplbacktext
    \put(0,0){\includegraphics[width={396.00bp},height={188.60bp}]{../Plots/SC40/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/mu-2.5/plot}}%
    \gplfronttext
  \end{picture}%
\endgroup
