...
%  The spectra composente eachother resulting in a zero net magnetisation.
...
of ferromagnets limits the frequency to the gigahertz range\rem{check the values at \url{https://www.nature.com/articles/158670a0}}. This has to deal with the ferromagnetic resonance that connects 
