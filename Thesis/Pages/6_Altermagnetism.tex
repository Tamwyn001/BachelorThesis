...
which leads to the name altermagnetism \cite{Smejkal2022_2}. \rem{maybe add a figure}. These properties puts the altermagnet in between
...
the magnetisation with electromagnetic waves. The altermagnets could be used in the terahertz range. \rem{spin transfer torque (STT) is linked to TMR?}
