...
\begin{align}
    \left(I_{i}^{\pm r}\right)_{hop} &= (c_{i\sigma}^{\dagger}c_{l\mp\delta_r,\sigma} -c_{i\sigma'}^{\dagger}c_{l\pm\delta_r,\sigma})  \\
    \left(I_{i}^{\pm r}\right)_{AM} &= \left(c_{l\mp\delta_r,\sigma}^{\dagger}c_{l\sigma} - c_{l\sigma}^{\dagger}c_{l\pm\delta_r,\sigma} \right) 
    \sum_{\sigma'}\bigl(\bm{m}_{l,l\pm\delta_r}\cdot\bm{\sigma}\bigr)_{\sigma\sigma'}
\end{align}
