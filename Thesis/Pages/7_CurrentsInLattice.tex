...
We as well reintroduce the minus of every summand of the Hamiltonian (due to their attractive nature) we let aside for the commutator relations.  Multiplied 
with the minus one from the Heisenberg picture, we obtain a positive expression. Further, taking $\im = -1/\im$ we get:
\begin{align}
