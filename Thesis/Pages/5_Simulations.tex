...
The goal of this thesis is to use nummerical methods to solve self-consitently the superconductive gap.
...
site specific physical quantities. These can be the superconducting gap or the current, etc.\\
...
performed until the difference of each gap with its previous value reaches a treshold. We then have a proper 
...
In the literature we find square lattices of $100\times100$ sites \cite{Mjos2019}. \\
% \subsection{Results}
