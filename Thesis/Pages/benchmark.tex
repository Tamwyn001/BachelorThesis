...
\begin{figure}[H]
    \centering
    \input{../Plots/SC15AM15/NotFourier/MeanLine/FreeDelta/allMU/plot.tex}
...
\begin{figure}[H]
    \centering
    \input{../Plots/SC12AM6SC12/NotFourier/MeanLine_Phase/FixedNormPhaseDelta/allMU/plot.tex}
    \caption{SC12AM6SC12 with $\mu=-3.75$ with a start at $\pi/3$}
\end{figure}
...
\begin{figure}[H]
    \centering
    \input{../Thesis/Plots/SC12AM6SC12/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/mu-2.2/starting_1.0472/plot.tex}
