...
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC15AM15/NotFourier/MeanLine/FreeDelta/diffMU/-2.75/plot.tex}
...
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC15AM15/NotFourier/MeanLinePhase/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/plot.tex}
%     \caption{SC15AM15 with $\mu = -2.75$}
% \end{figure}
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC15AM15/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot.tex}
%     \caption{SC15AM15 with $\mu = -2.75$}
% \end{figure}
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC15AM15/NotFourier/Continuity/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot.tex}
%     \caption{SC15AM15 with $\mu = -2.75$}
% \end{figure}
...
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC12AM6SC12/NotFourier/FreeDelta/diffMU/-2.75plot.tex}
%     \caption{SC12AM6SC12 with $\mu = -2.75$, free}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC12AM6SC12/NotFourier/Meanline/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot.tex}
...
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC12AM6SC12/NotFourier/Meanline_Phase/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot.tex}
%     \caption{SC12AM6SC12 with $\mu = -2.75$}
% \end{figure}
...
% \begin{figure}[H]
%     \centering
%     \input{../Plots/SC12AM6SC12/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/diffMU/-2.75/Starting_1.0472/plot.tex}
%     \caption{SC12AM6SC12 with $\mu = -2.75$}
% \end{figure}
