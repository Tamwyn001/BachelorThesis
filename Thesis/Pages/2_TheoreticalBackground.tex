...
\begin{figure}[H]\centering
    ...
    \begin{tikzpicture}
        ...
        On the right is a simplified version of the potential that revealed itself to be very accurate with the experiments.
        $-\omega_q$ is an arbitrary value. Inspired by \cite{FossheimSudbo2004}.}
    \end{figure}
