...
The orthonal property of the single-particle wavefunction propagtes itselfs \rem{itselfs/itself}:
\[
...
The Coulomb force is known to degrow with the inverse of the distance. This term depends on the distance $\bm{r}-\bm{r}'$
between the electrons, but not on their respective positions $\bm{r}$ and $\bm{r}'$. This exchange is therfore invariant under translations.
...
\end{figure}
This closes the introduction theorie on the second quantisation. We saw how we can express integral over wavefunctions as bra-kets scalarproducts. 
...
The goal of this thesis is to study how the superconductivity behaves in the prooximity of an altermagnet. 
...
Let's asume we have an impotent Fermi sea where the electrons as considered non interacting. Adding to electrons requires to place them
