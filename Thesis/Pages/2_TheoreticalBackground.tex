...
We used $n_{\nu}$, which represents the number of particle in the state $\nu$. Therefor \rem{agree on therefor or therfore} we usely
 call it the occupation number of the state $\nu$.
...
The Fermi-liquid remains stable to the repulsive processes.\rem{how can we deduce it?}\\
...
We now understand why attractive processes create instabilities in the liquid. An engery gap opens next to the energy surface,
