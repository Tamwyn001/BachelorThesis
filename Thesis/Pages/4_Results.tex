...
\end{figure}
The superconducting gap lies around $0.01\cdot U$ and $0.16\cdot U$ \rem{eV?} for the range of selected chemical potentials. Further we observe a 
...
\rem{Whih the vertical periodic boundary condition we expect to have a uniform current along the $y$ direction.}
...
\rem{This is going to be re simulated with vertical periodic boundary conditions and other $\mu$s. I'm
