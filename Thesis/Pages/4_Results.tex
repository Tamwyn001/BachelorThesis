...
\begin{figure}[H]
    \input{../Plots/SC30/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/mu-0.5/plot.tex}
    \caption{Current from a phase gradient of $117^{\circ}$ at $\mu = -0.5$.}
\end{figure}
\begin{figure}[H]
    \input{../Plots/SC30/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/mu-1.5/plot.tex}
    \caption{Current from a phase gradient of $117^{\circ}$ at $\mu = -1.5$.}
\end{figure}
\begin{figure}[H]
    \input{../Plots/SC30/NotFourier/Currents/FixedLinearPhaseGradient/Phase117deg/mu-2.5/plot.tex}
...
\begin{figure}[H]
    \centering
    \input{../Plots/SC30/NotFourier/Continuity/FixedLinearPhaseGradient/Phase117deg/mu-0.5/plot.tex}
...
\begin{figure}[H]
    \centering
    \input{../Plots/SC30/NotFourier/Continuity/FixedLinearPhaseGradient/Phase117deg/mu-1.5/plot.tex}
    \caption{Continuity of the current from a phase gradient of $117^{\circ}$ at $\mu = -1.5$. In both $x$ and $y$ direction as
    well as the total continuity.}
\end{figure}
\begin{figure}[H]
    \centering
    \input{../Plots/SC30/NotFourier/Continuity/FixedLinearPhaseGradient/Phase117deg/mu-2.5/plot.tex}
