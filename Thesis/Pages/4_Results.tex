...
We can experiemntaly apply a voltage difference between the two sides of the superconductor to induce a phase gradient \rem{source}.
...
\rem{Here the current varies along the $y$ direction but after the use of vertical boundary conditions we will have a uniform patern.
...
\rem{Whith the vertical periodic boundary condition we expect to have a uniform current along the $y$ direction.}
...
\rem{This is going to be resimulated with vertical periodic boundary conditions and other $\mu$s. I'm
confident on the results I'll get, the interpretation will be written as well for monday.}
\begin{figure}[H]
