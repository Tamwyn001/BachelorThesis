classdef SystemBase
    ...
    properties (Constant)
        ...
        guessDelta = 2.0* 0.02; % for detla or to scale the F yx+-
        ...
        layer =  ["SC", 40] %["SC", 12, "AM", 6, "SC", 12]; %superconducting and altermgnet layer separated verticaly ["SC", 10, "AM", 4, "SC", 10]
