...
plot [1:30] \
    ...
    dataroot.'/0.75/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize 0.75' dashtype 3 lw 4 lc palette frac 1.0,\
    dataroot.'/2.75/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize 2.75' dashtype 3 lw 4 lc palette frac 0.8,\
    dataroot.'/1.75/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize 1.75' dashtype 3 lw 4 lc palette frac 0.6,\
