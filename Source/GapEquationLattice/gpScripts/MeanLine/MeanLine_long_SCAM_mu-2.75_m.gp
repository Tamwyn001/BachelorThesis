...
plot [1:30] \
    ...
    dataroot.'/SC15AM15_m0.25/'.sys.'/meanline_30x15NoBC.dat' using 1:($2*10) with lines title '\footnotesize  $m=0.25$' dashtype 1 lw 3.5 lc palette frac 0.4,\
    dataroot.'/SC15AM15_m0.5/'.sys.'/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize  $m=0.5$' dashtype 1 lw 3.5 lc palette frac 0.6,\
    dataroot.'/SC15AM15_m0.75/'.sys.'/meanline_30x15NoBC.dat' using 1:($2*10) with lines title '\footnotesize  $m=0.75$' dashtype 1 lw 3.5 lc palette frac 0.8,\
...
# set ytics add ("\\tiny \\(10^{-2}\\)" 1.0e-2, "\\tiny \\(10^{-4}\\)" 1.0e-4)  # Add labeled ticks at specific positions
# set mytics 5 
# unset xlabel
# unset ylabel
# unset label
...
# unset object 1
# plot [14:30]\
#     dataroot.'/SC15AM15_m0.5/'.sys.'/meanline_30x15NoBC.dat' using 1:2 with lines dashtype 1 lw 3.5 lc palette frac 0.6,\
