...
plot [1:30] \
    ...
    dataroot.'/SC15AM15_m0.25/'.sys.'/meanline_30x20NoBC.dat' using 1:($2*10) with lines title '\footnotesize  $m=0.25$' dashtype 1 lw 3.5 lc palette frac 0.4,\
    ...
    dataroot.'/SC15AM15_m0.75/'.sys.'/meanline_30x20NoBC.dat' using 1:($2*10) with lines title '\footnotesize  $m=0.75$' dashtype 1 lw 3.5 lc palette frac 0.8,\
