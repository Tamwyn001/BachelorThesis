...
set yrange[0:180]
plot [1:30] \
    dataroot.'/-3.75/Starting_at/1.0472/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =-3.75$' dashtype 1 lw 3.5 lc palette frac 0.0,\
    ...
    dataroot.'/-2.2/Starting_at/1.0472/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =-2.2$' dashtype 1 lw 3.5 lc palette frac 0.6,\
    dataroot.'/2.75/Starting_at/1.0472/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =2.75$' dashtype 1 lw 3.5 lc palette frac 1,\
