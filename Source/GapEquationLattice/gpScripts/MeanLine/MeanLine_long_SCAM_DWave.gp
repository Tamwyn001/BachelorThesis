...
set logscale y
dataroot = './Results/SC20AM20_m0.5/DWave/StraightInterface/FreeDelta/diffMU/'
...
plot [1:40] \
    dataroot.'-0.5/meanline_40x30NoBC_F_D10.dat' using 1:2 with lines title '\footnotesize -0.5' dashtype 1 lw 3.5 lc palette frac 0.2,\
    dataroot.'-1.5/meanline_40x30NoBC_F_D10.dat' using 1:2 with lines title '\footnotesize -1.5' dashtype 1 lw 3.5 lc palette frac 1.0,\
    dataroot.'-2.5/meanline_40x30NoBC_F_D10.dat' using 1:2 with lines title '\footnotesize -2.5' dashtype 1 lw 3.5 lc palette frac 0.6,\
