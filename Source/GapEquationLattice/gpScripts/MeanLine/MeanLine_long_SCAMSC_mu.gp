...
plot [1:30] \
    ...
    dataroot.'/-2.2/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize -2.2' dashtype 1 lw 3.5 lc palette frac 0.8, \
    dataroot.'/-1.75/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize -1.75' dashtype 1 lw 3.5 lc palette frac 1, \
    dataroot.'/1.75/meanline_30x15NoBC.dat' using 1:2 with lines title '\footnotesize 1.75' dashtype 3 lw 3.5 lc palette frac 1, \
