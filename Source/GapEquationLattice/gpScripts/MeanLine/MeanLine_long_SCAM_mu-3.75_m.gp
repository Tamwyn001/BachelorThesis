...
plot [1:30] \
    ...
    dataroot.'/SC15AM15_m0.5/'.sys.'/meanline_30x20NoBC.dat' using 1:($2*2000) with lines title '\footnotesize  $m=0.5$' dashtype 1 lw 3.5 lc palette frac 0.6,\
...
unset object 1
plot [14:30]\
    dataroot.'/SC15AM15_m0.75/'.sys.'/meanline_30x20NoBC.dat' using 1:2 with lines dashtype 1 lw 3.5 lc palette frac 0.8,\
