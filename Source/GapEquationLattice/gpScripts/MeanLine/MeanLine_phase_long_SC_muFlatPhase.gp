...
plot [1:30] \
    ...
    dataroot.'/-2.75/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =-2.75$' dashtype 1 lw 3.5 lc palette frac 0.4, \
    dataroot.'/-1.75/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =-1.75$' dashtype 1 lw 3.5 lc palette frac 0.6,\
    dataroot.'/1.75/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =1.75$' dashtype 3 lw 3.5 lc palette frac 0.8, \
    dataroot.'/2.75/meanline_Phase_30x15VertBC.dat' using 1:($2*180/pi) with lines title '\footnotesize $\mu =2.75$' dashtype 3 lw 3.5 lc palette frac 1.0
set out
