...
plot [1: 30] dataroot.'/meanline_30x30NoBC.dat' using 1:2 with lines title '\footnotesize No BC' lw 5 linecolor rgb "#666A86",\
 dataroot.'/meanline_30x30VertBC.dat' using 1:2 with lines title '\footnotesize Vert BC' lw 5 linecolor rgb "#92B6B1",\
 dataroot.'/meanline_30x30VertHorizBC.dat' using 1:2 with lines title '\footnotesize Vert \& horiz BC' lw 5 linecolor rgb "#E8DDB5"
set out
# pause -1
